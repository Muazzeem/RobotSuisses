            ...
            <section class="hero-section">
                <NuxtLink to="/blog/small-business-guide" class="featured-post">
                    <div class="featured-image">
                        <img src="https://images.pexels.com/photos/8438922/pexels-photo-8438922.jpeg?auto=compress&cs=tinysrgb&w=800"
                            alt="Featured post" />
                    </div>
                    <div class="featured-content">
                        <time class="featured-date">26 Feb 2025</time>
                        <h1 class="featured-title">Small Business Guide: Getting Started with Robotic Automation
                        </h1>
                        <p class="featured-excerpt">
                            A comprehensive guide for Swiss SMEs looking to implement their first robotic solutions
